...
public class Delete implements Initializable {
    ...
    public void deletAll(ActionEvent event) {
        ...
        SessionFactory sf = new Configuration().configure("/main/src/config/ProjectConfig.xml").buildSessionFactory();
    ...
    public void alarm() {
        ...
        try {
            ...
            Pane root = (Pane) loader.load(getClass().getResource("/main/java/delete/alarm.fxml"));
